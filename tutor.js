import { TUTOR_TOPICS, GRAMMAR_CONCEPTS, PHRASES, WORDS, PATTERNS } from './data.js?v=1.2.2';
import { normalizeText, similarity, getWeakItems, getMetrics } from './engine.js?v=1.2.2';
